...
(0, _cucumber.Then)(/^I fill in the "([^"]*)" input on the "([0-9]+th|[0-9]+st|[0-9]+nd|[0-9]+rd)" (?:tab|window) with "([^"]*)"$/, /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(elementKey, elementPosition, input) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            console.log("I fill in the ".concat(elementKey, " input on the ").concat(elementPosition, " tab|window with ").concat(input));
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 3:
                      ...
                      _context.next = 7;
                      return (0, _htmlBehavior.inputValueOnPage)(pages, pageIndex, elementIdentifier, input);
